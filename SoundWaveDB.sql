...
GRANT ALL ON `SoundWaveDB`.* TO 'admin'@'%' IDENTIFIED BY 'password';
USE `SoundWaveDB` ;
...
INSERT INTO Account
VALUES 
('Sbugheaz', 'Giacop96', 'gianmarco.coppola@community.unipa.it', 'Gianmarco', 'Coppola', 'M', '1996-10-19', 0, 1),
('ElMosca96', 'Giumos96', 'giuseppe.moscarelli96@gmail.com', 'Giuseppe', 'Moscarelli', 'M', '1996-06-05', 0, 1),
('Aries96', 'Andvar96', 'andryplus96@gmail.com', 'Andrea', 'Vara', 'M', '1996-06-10', 0, 0);
...
CREATE TABLE IF NOT EXISTS `SoundWaveDB`.`Amicizia` (
  ...
  CONSTRAINT `fk_Amicizia_Account1`
    ...
    REFERENCES `SoundWaveDB`.`Account` (`NomeUtente`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
